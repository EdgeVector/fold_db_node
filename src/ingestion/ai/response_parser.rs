//! AI response parsing: JSON extraction, validation, and conversion.
//!
//! Takes raw AI text output and produces validated `AISchemaResponse` structs.

use super::helpers::AISchemaResponse;
