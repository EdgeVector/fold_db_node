...
function SchemaServiceSettings() {
  const [schemaServiceUrl, setSchemaServiceUrl] = useState<string | null>(null)
  ...
  const loadSchemaServiceStatus = async () => {
    ...
    try {
      ...
      if (response.success && response.data) {
        const url = (response.data as { schema_service_url?: string }).schema_service_url
        setSchemaServiceUrl(url || null)
      }
    } catch (error) {
