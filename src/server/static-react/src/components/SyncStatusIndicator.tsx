...
import { systemClient, type SyncStatusResponse } from '../api/clients/systemClient'
import { usePolling } from '../hooks/usePolling'

function formatTimestamp(unixSecs: number | undefined): string | null {
...
function SyncStatusIndicator({ onCloudSettingsClick }: SyncStatusIndicatorProps) {
