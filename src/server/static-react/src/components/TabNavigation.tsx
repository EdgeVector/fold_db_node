...
import { DEFAULT_TABS, type TabDefinition } from '../constants/ui';

type TabWithDisabled = TabDefinition & { disabled?: boolean };

interface TabNavigationProps {
  tabs?: readonly TabWithDisabled[];
  activeTab: string;
...
function TabNavigation({
  ...
  const renderTab = (tab: TabWithDisabled) => {
