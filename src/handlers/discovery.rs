...
///
/// Reads photo records from FoldDB, extracts EXIF timestamps and GPS coordinates,
/// and generates HMAC-SHA256 hashes for each peer using a per-pair shared secret.
...
pub async fn moment_receive_hashes(
    ...
    // Verify we have an opt-in for this peer
